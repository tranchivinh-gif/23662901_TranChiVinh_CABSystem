...
## Quy ước áp dụng xuyên suốt SRS v2

Để tránh mâu thuẫn giữa các phần được lập ở các thời điểm khác nhau, các quyết định dưới đây là **baseline nghiệp vụ của phiên bản MVP**. Khi một bảng hoặc sơ đồ ở phần trước còn ghi `[Cần làm rõ]` nhưng nội dung đã được chốt trong baseline này, baseline được ưu tiên và trạng thái phải được hiểu là `Đã xác nhận` hoặc `Đề xuất MVP` tương ứng.

| Chủ đề | Quyết định áp dụng trong SRS v2 | Mức độ |
| --- | --- | --- |
| Vị trí và ETA | Cập nhật vị trí tài xế khoảng 10 giây/lần khi hoạt động/đang chạy; mục tiêu chính xác khoảng 50 m khi GPS phù hợp; ETA dựa trên vị trí và khoảng cách, chưa tích hợp giao thông thời gian thực. | Đã xác nhận |
| Phân công tài xế | Hệ thống tự động tìm và phân công theo vị trí, trạng thái sẵn sàng, loại xe và khả năng đáp ứng; không phản hồi trong 30 giây được xử lý như từ chối và tìm tiếp. | Đã xác nhận |
| Hủy chuyến | Khách hàng được hủy trước trạng thái khóa hủy và trước khi hoàn thành; tài xế chỉ từ chối trước khi nhận, sau đó yêu cầu hủy hoặc báo sự cố; MVP chưa thu phí hủy. | Đề xuất MVP |
| Thanh toán | Hỗ trợ tiền mặt và điện tử; tiền mặt hoàn tất khi tài xế xác nhận đã thu đủ; điện tử retry tối đa 3 lần trong 30 phút; chỉ lưu mã và trạng thái giao dịch, không lưu dữ liệu nhạy cảm. | Đã xác nhận |
| Thông báo | MVP dùng thông báo trong hệ thống và email; retry tối đa 3 lần, không tự chuyển kênh sau khi retry thất bại; provider/kênh được thiết kế để thay thế về sau. | Đề xuất MVP |
| Phân quyền | RBAC gồm Nhân viên vận hành và Quản trị viên; chỉ Quản trị viên được cấp/thay đổi quyền; Ban lãnh đạo chỉ xem báo cáo tổng hợp. | Đề xuất MVP |
| Báo cáo | Có ngày/tuần/tháng và khoảng thời gian tùy chọn; lọc theo thời gian, tài xế, loại xe, trạng thái; dùng công thức tỷ lệ hoàn thành/hủy đã nêu trong phản hồi v2. | Đã xác nhận |
| Lưu trữ và kiểm toán | Chuyến/giao dịch 24 tháng, vị trí chi tiết 30 ngày, audit log 12 tháng; sau hạn xóa hoặc lưu trữ theo chính sách doanh nghiệp. | Đề xuất |
| NFR MVP | Khoảng 500 người dùng đồng thời, phản hồi thao tác thông thường không quá 3 giây, khả dụng đề xuất 99,5%, sao lưu hằng ngày, RTO không quá 4 giờ và RPO không quá 24 giờ. | Đề xuất, cần phê duyệt nghiệm thu |

Các đề xuất trên là giả định làm việc để hoàn thiện SRS và xây dựng/kiểm thử MVP, không thay thế phê duyệt cuối của khách hàng. Những nội dung còn mở ở cuối tài liệu chỉ là thông số cần phê duyệt hoặc chi tiết cấu hình, không phải khoảng trống chức năng.
...
| NEED-07 | Cập nhật các trạng thái chuyến đúng trình tự, không bỏ qua trạng thái; sau khi nhận chuyến chỉ yêu cầu hủy/báo sự cố theo chính sách            | Tài xế                           | Rõ; trạng thái khóa hủy áp dụng theo baseline MVP              | [P5], phản hồi v2  |
...
| NEED-09 | Hệ thống tự động tìm/phân công tài xế theo tiêu chí cấu hình; không phản hồi trong 30 giây được xem như từ chối và tìm tiếp                     | Doanh nghiệp, khách hàng, tài xế | Rõ; tiêu chí khả năng đáp ứng theo cấu hình vận hành            | [P6], phản hồi v2  |
...
| NEED-11 | Hệ thống tự động tính cước sau khi hoàn thành từ bảng giá cấu hình và thông tin chuyến                                                          | Khách hàng, doanh nghiệp         | Rõ; chi tiết bảng giá là cấu hình cần phê duyệt                | [P7], phản hồi v2  |
...
| NEED-16 | Phân quyền theo vai trò Nhân viên vận hành và Quản trị viên; chỉ Quản trị viên cấp/thay đổi quyền                                               | Nhân viên vận hành, doanh nghiệp | Rõ ở mức MVP; ma trận quyền chi tiết là cấu hình               | [P9], phản hồi v2  |
| NEED-17 | Báo cáo theo ngày/tuần/tháng hoặc khoảng thời gian, lọc theo thời gian, tài xế, loại xe và trạng thái; có công thức tỷ lệ hoàn thành/hủy        | Ban lãnh đạo, nhân viên vận hành | Rõ; chỉ số hiệu quả tài xế dùng nhóm KPI đã xác định            | [P9], phản hồi v2  |
...
| BR-03 | Hệ thống cần hỗ trợ khách hàng theo dõi quá trình xử lý và trạng thái chuyến xe.                                                                                                                                        | NEED-03; [P4]                   | STK-02                         | S-F04           | Đã xác nhận; ETA theo vị trí/khoảng cách trong baseline MVP      |
...
| BR-07 | Hệ thống cần hỗ trợ tài xế cập nhật tiến trình thực hiện chuyến từ khi đến điểm đón đến khi hoàn thành.                                                                                                                 | NEED-07; [P5]                   | STK-03, STK-02                 | S-F04           | Đã xác nhận; áp dụng chuyển trạng thái tuần tự                    |
| BR-08 | Hệ thống cần quản lý thông tin vị trí tài xế để hỗ trợ tìm tài xế gần khách hàng và cải thiện thời gian dự kiến đến.                                                                                                    | NEED-08; [P5]                   | STK-01, STK-03                 | S-F03, S-F05    | Đã xác nhận; cập nhật khoảng 10 giây, mục tiêu khoảng 50 m      |
| BR-09 | Hệ thống cần tự động tìm và ưu tiên tài xế phù hợp dựa trên vị trí hiện tại, trạng thái sẵn sàng và loại xe; nếu có nhiều ứng viên, ưu tiên khoảng cách hoặc thời gian dự kiến đến điểm đón thấp nhất.                  | NEED-09; [P6], phản hồi bổ sung | STK-01, STK-02, STK-03, STK-04 | S-F03           | Đã xác nhận; ETA theo vị trí/khoảng cách                         |
| BR-10 | Hệ thống cần hỗ trợ tiếp tục tìm tài xế khác khi tài xế được đề xuất không phản hồi hoặc từ chối, đồng thời thông báo khi không tìm được tài xế.                                                                        | NEED-09; [P6]                   | STK-02, STK-03, STK-04         | S-F03, S-F07    | Đã xác nhận; timeout không phản hồi là 30 giây                    |
| BR-11 | Hệ thống cần hỗ trợ gửi thông báo về các sự kiện quan trọng của yêu cầu đặt xe, chuyến xe, tài xế và thanh toán đến các bên liên quan.                                                                                  | NEED-10; [P8]                   | STK-02, STK-03, STK-04, STK-07 | S-F07           | Đã xác nhận; in-app/email, retry tối đa 3 lần                     |
| BR-12 | Hệ thống cần xác định số tiền khách hàng phải trả khi chuyến hoàn thành bằng bảng giá cấu hình theo loại dịch vụ/loại xe, có thể gồm giá tối thiểu và phụ phí; kết quả phải được lưu để thanh toán, lịch sử và tra cứu. | NEED-11; [P7], phản hồi bổ sung | STK-01, STK-02, STK-05         | S-F06           | Đã xác nhận; công thức chi tiết là cấu hình cần phê duyệt         |
...
| ------ | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ------------------------------------- | ----------------------------------------------- |
| NFR-01 | Performance       | Hệ thống cần hoạt động ổn định với mức tải MVP khoảng 500 người dùng đồng thời và có khả năng mở rộng khi tải tăng.                                         | FR-04, FR-09, FR-26, BRULE-20                          | Đánh giá hoạt động ở 500 người dùng đồng thời; khả năng mở rộng tiếp theo là định hướng.                            | Cao        | NEED-18; phản hồi v2                  | Đề xuất MVP; cần phê duyệt nghiệm thu   |
| NFR-02 | Performance       | Các thao tác thông thường có mục tiêu thời gian phản hồi không quá 3 giây trong điều kiện tải MVP.                                                                  | FR-04, FR-05, FR-08, FR-09                             | Đo p95 thời gian phản hồi của các luồng nghiệp vụ chính; ngưỡng là đề xuất nghiệm thu.                                         | Cao        | NEED-03, NEED-09; phản hồi bổ sung    | Đề xuất MVP; cần phê duyệt nghiệm thu    |
...
| NFR-05 | Security          | Thao tác quản trị phải được kiểm soát theo RBAC; người không có quyền không được thực hiện thao tác nhạy cảm.                                                | FR-21, FR-22, BRULE-17, EX-16                          | Kiểm tra theo hai vai trò MVP; chỉ Quản trị viên được cấp/thay đổi quyền.                                              | Cao        | NEED-16; [P9], [P11]                  | Đã xác nhận; cấu hình mở rộng có thể bổ sung                |
...
| NFR-08 | Security          | Các thao tác quan trọng cần có khả năng truy xuất để phục vụ kiểm tra khi xảy ra sự cố.                                                                                | FR-25, BRULE-18                                        | Ghi nhận đăng nhập, đổi quyền, đổi dữ liệu quan trọng, xử lý sự cố và thao tác quản trị; lưu đề xuất 12 tháng.                              | Cao        | NEED-19; [P11], phản hồi v2            | Đã xác nhận; thời gian lưu là đề xuất                |
...
RTM tổng hợp theo chuỗi `NEED -> STK -> SCOPE -> BR -> BP -> Step -> FR -> FR con -> Rule/Exception -> NFR -> DATA -> ACTOR/UC -> AC`. Cột Scope dùng các mã phạm vi đã được xác định là `S-F01` đến `S-F11`; `N/A` nghĩa là thành phần không áp dụng cho dòng đó. Các nhãn `[Suy ra]` và `[Cần làm rõ]` trong các bảng lịch sử được giữ để bảo toàn nguồn gốc; khi nội dung đã được phản hồi v2 hoặc baseline đầu tài liệu chốt, trạng thái thực thi được lấy theo baseline và bảng `OPEN-01` đến `OPEN-10`.
...
## 6. Nội dung còn cần xác nhận và đề xuất hoàn thiện

Các nội dung dưới đây không còn là khoảng trống chức năng; đây là các quyết định cấu hình/chính sách cần khách hàng phê duyệt trước khi nghiệm thu. SRS áp dụng giá trị đề xuất để các nhóm phân tích, phát triển và kiểm thử có một baseline thống nhất.

| Mã | Nội dung cần phê duyệt | Đề xuất áp dụng cho MVP | Ảnh hưởng |
| --- | --- | --- | --- |
| OPEN-01 | Công thức cước và bảng giá | Bảng giá versioned theo loại dịch vụ/loại xe, gồm giá tối thiểu và phụ phí nếu có; chỉ Quản trị viên được sửa, chuyến đã hoàn thành giữ nguyên phiên bản giá. | BR-12, FR-13, UC-09 |
| OPEN-02 | Trạng thái khóa hủy | Khóa hủy khi chuyến đã hoàn thành; với chuyến đang thực hiện, chỉ cho hủy theo sự cố/policy của vận hành. | BR-07, BR-13, UC-08 |
| OPEN-03 | Hoàn tiền điện tử | CAB không tự quyết định số tiền hoàn; ghi nhận yêu cầu và chuyển Payment Provider xử lý theo chính sách provider, lưu mã tham chiếu và trạng thái đối soát. | BR-14, FR-18 |
| OPEN-04 | Trạng thái sự cố | Bổ sung `INCIDENT_REPORTED`, `CANCELLED` và `INCIDENT_RESOLVED`; vận hành bắt buộc ghi lý do và kết quả trước khi đóng sự cố. | BR-16, FR-21, UC-08 |
| OPEN-05 | Mất kết nối | Cho phép lưu cục bộ sự kiện trạng thái chưa đồng bộ, gửi lại khi kết nối phục hồi; không hiển thị thành công nếu máy chủ chưa xác nhận. | BR-07, NFR-11, AC-16 |
| OPEN-06 | Ma trận quyền MVP | Nhân viên vận hành được xem/cập nhật nghiệp vụ; Quản trị viên được quản lý tài khoản, quyền và cấu hình; thay đổi quyền, giao dịch và trạng thái chuyến phải audit. | BR-17, FR-22, UC-13 |
| OPEN-07 | KPI hiệu quả tài xế | Hiển thị số chuyến nhận, hoàn thành, từ chối/hủy và điểm đánh giá; không gộp dữ liệu thiếu mẫu vào tỷ lệ. | BR-18, FR-27, UC-16 |
| OPEN-08 | NFR nghiệm thu | Dùng kịch bản tải 500 người dùng đồng thời, p95 thao tác thông thường không quá 3 giây; đo khả dụng theo tháng; kiểm tra backup/khôi phục theo RTO/RPO. | BR-20, NFR-01, NFR-02 |
| OPEN-09 | Lịch sử và đánh giá | Giữ trong MVP vì đã nêu trong yêu cầu khách hàng: khách hàng xem lịch sử, số tiền và gửi một đánh giá sau chuyến hoàn thành. | NEED-04, FR-09, FR-10 |
| OPEN-10 | Actor mở rộng nền tảng | Chưa tạo actor vận hành mới; yêu cầu mở rộng được quản lý như backlog/change request bởi đại diện doanh nghiệp và nhóm phát triển. | BR-19, BR-20, BP-08 |
...
- Các nội dung chưa được phản hồi v2 chốt đã có đề xuất baseline tại `OPEN-01` đến `OPEN-10`; chỉ cần phê duyệt hoặc thay thế giá trị, không cần tạo lại chuỗi truy xuất.

## 8. Kết luận hoàn thiện SRS

SRS v2 hiện bao phủ đầy đủ chuỗi `NEED -> STK -> SCOPE -> BR -> BP -> STEP -> FR -> Rule/Exception -> NFR -> DATA -> ACTOR/UC -> AC -> RTM`. Các yêu cầu trực tiếp từ `Customer-Requirement.docx` và phản hồi bổ sung v2 đã được phản ánh ở mức nghiệp vụ, dữ liệu phân tích, Use Case và điều kiện nghiệm thu. Các đề xuất mới chỉ làm rõ cách vận hành MVP, không mở rộng ngoài phạm vi đã xác định và không thay thế quyết định phê duyệt của khách hàng.
